...
export function AboutSection() {
   return (
      <section id="sobre" className="background-white">
         <div className="container">
            ...
            <div>
               ...
               <p className="text">
                  ...
                  dapibus. Cras in dolor velit. Integer pharetra condimentum tempus. Sed
                  odio sem, iaculis at dapibus a, aliquet nec risus. Aenean ullamcorper
                  nibh vitae quam eleifend elementum eu ut sem.
               </p>
            </div>
         </div>
      </section>
